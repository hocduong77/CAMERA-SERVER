...
http://user:pass@mydomain.com/mjpeg</pre>
			...
			<div id="urldiv" class="form-group">
				<label id="urltextdiv" class="col-sm-2 control-label">URL of
					your camera:</label>
				<div class="col-sm-4">
					<input type="text" id="urledit" name="urledit"
						class="form-control error"><label for="urledit"
			...
			<table class="table table-striped">
				<tbody>
					<tr>
						...
						<td><br> <!-- <button id="addbutton" class="btn btn-success pull-left">Add camera</button> -->

						</td>
					</tr>
					<tr>
						<form action="<c:url value="/saveCamera" />" method="get"
